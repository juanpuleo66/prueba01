...
var ConfigNewComponent = (function () {
    function ConfigNewComponent(_loginService, _configsService, _route, _router, _generalServices) {
        this._loginService = _loginService;
        this._configsService = _configsService;
        this._route = _route;
        this._router = _router;
        this._generalServices = _generalServices;
        this.titulo = 'Create Config';
    ...
    ConfigNewComponent.prototype.viewParameters = function () {
        // 	expands collapses the parameters view in config.new.html
        this.viewParam = (this.viewParam == true) ? false : true;
    };
    ConfigNewComponent.prototype.getResources = function () {
        var _this = this;
        this.loading = 'show';
    ...
    ConfigNewComponent.prototype.getScripts = function () {
        var _this = this;
        ...
        this._configsService.searchScripts(token).subscribe(function (responsec) {
            ...
            if (_this.status != "success") {
                ...
                _this.idScript = _this.scripts[0].aid;
                _this.getParameters(_this.idScript);
            }
        }, function (error) {
            _this.errorMessage = error;
            if (_this.errorMessage != null) {
    ...
    ConfigNewComponent.prototype.getParameters = function (idScript) {
        var _this = this;
        ...
        this._configsService.searchParameters(token, idScript).subscribe(function (responsed) {
            ...
            if (_this.status != "success") {
                ...
                var lenParameters = _this.parameters.length;
                _this.arrparamvalues = [];
                // initializes the array for the id and values for the parameters
                for (var i = 0; i < lenParameters; i++) {
                    _this.arrparamvalues[i] = new paramvalues_1.Paramvalues(_this.parameters[i].bid, _this.parameters[i].bidScript, _this.parameters[i].did, null, _this.parameters[i].bid, '', _this.parameters[i].bparamName, _this.parameters[i].bparamDescription, _this.parameters[i].bparamMandatory);
                }
            }
        }, function (error) {
            _this.errorMessage = error;
    ...
    ConfigNewComponent.prototype.addInputResource = function (gid, gname) {
    ...
    ConfigNewComponent.prototype.removeInputResource = function (indice) {
        this.inputResources.splice(indice, 1);
    };
    ConfigNewComponent.prototype.addOutputResource = function (gid, gname) {
    ...
    ConfigNewComponent.prototype.removeOutputResource = function (indice) {
    ...
    ConfigNewComponent.prototype.onSubmit = function () {
        ...
        if (cont) {
            ...
            this._configsService.register(token, this.config, dataConfig, this.itemsPerPage).subscribe(function (response) {
    ...
    ConfigNewComponent.prototype.fileChangeEvent = function (fileInput) {
    ...
    ConfigNewComponent.prototype.verifyExtension = function (file) {
        var extensions_allowed = new Array(".json");
    ...
    ConfigNewComponent.prototype.findResources = function (configResources) {
    ...
    ConfigNewComponent.prototype.importConfigFromFileJson = function (file) {
        ...
        reader.onload = function (e) {
            try {
                ...
                if (configData) {
                    self.config = new config_1.Config(configData.id, configData.scriptConfigName, configData.idScript, "", configData.type);
                ...
                self.code = 400;
                self.config = new config_1.Config(1, "", 1, "", "");
                self.idScript = -1;
    ...
    ], ConfigNewComponent.prototype, "windowModalMessage", void 0);
